...
possible_ms = [num*0.1 for num in range(-100, 101)]#your list comprehension here
print(possible_ms)
...
possible_bs = [num*.01 for num in range(-200, 201)]#your list comprehension here
#print(possible_bs)
...
datapoints = [(1, 2), (2, 0), (3, 4), (4, 4), (5, 3)]
def minimal_error(possible_ms, possible_bs, datapoints):
...
print(minimal_error(possible_ms, possible_bs, datapoints))
